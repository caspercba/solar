...
**Field index map** (for the `field` array):
...
| 5 | Batt Current | A | Negative = discharging |
...
| 9 | rated power | W | Inverter rated power (5200 W) |
| 10 | PInverter | W | Inverter active power |
| 11 | Accumulated Load Power | kWh | Lifetime load energy |
| 12 | Accumulated Self_Use Power | kWh | — |
| 13 | Accumulated PV Power | kWh | Lifetime PV energy |
...
### 4.14 Other actions referenced in portal JS
