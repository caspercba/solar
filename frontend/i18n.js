...
const messages = {
  en: {
    ...
    adminCreateUserHint: "Create an account immediately with username and password. No invite required.",
    adminCreateUserUsername: "Username",
    adminCreateUserUsernamePlaceholder: "e.g. ana",
    adminCreateUserPassword: "Password",
    adminCreateUserPasswordPlaceholder: "At least 8 characters",
    ...
    adminUserCreatedAt: "Created {when}",
    adminUserLastLogin: "Last login {when}",
    adminUserNeverLoggedIn: "Never logged in",
  ...
  es: {
    ...
    adminCreateUserHint: "Crea una cuenta de inmediato con usuario y contraseña. No se requiere invitación.",
    adminCreateUserUsername: "Usuario",
    adminCreateUserUsernamePlaceholder: "p. ej. ana",
    adminCreateUserPassword: "Contraseña",
    adminCreateUserPasswordPlaceholder: "Al menos 8 caracteres",
    ...
    adminUserCreatedAt: "Creado {when}",
    adminUserLastLogin: "Último acceso {when}",
    adminUserNeverLoggedIn: "Nunca ha iniciado sesión",
    adminUserDisabled: "Deshabilitado",
