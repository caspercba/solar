...
const messages = {
  en: {
    ...
    authModeToken: "Access token",
    authTokenHint: "For Home Assistant and migration. Prefer password login when you have an account.",
    confirmPassword: "Confirm password",
    passwordMismatch: "Passwords do not match",
    passwordTooShort: "Password must be at least 8 characters",
    inviteSubtitle: "Accept your invite",
    inviteAccept: "Create account",
    inviteAccepting: "Creating account…",
    inviteMissing: "Invite link is missing or incomplete",
    ...
    inviteUnavailable: "This invite is not available",
    language: "Language",
    langEn: "English",
    langEs: "Español",
    ...
    adminInvitesHint: "Magic links — copy and share out-of-band",
    adminCreateUser: "Create user",
    adminCreateUserBtn: "Create user",
    adminCreateInvite: "Create invite",
    adminCreateInviteBtn: "Create invite",
    adminRole: "Role",
    roleRead: "read",
    roleAdmin: "admin",
    ...
    adminInviteCopyOnce: "Copy this link now — it won’t be shown again",
    adminCopyLink: "Copy link",
    adminCopied: "Copied",
    adminPurgeInvites: "Purge stale",
    adminPurgeConfirm: "Remove all converted, revoked, and expired invites?",
    adminPurgeDone: "Purged {count} invite(s)",
    adminNoUsers: "No password users yet.",
    adminNoInvites: "No invites yet.",
    ...
    adminEnable: "Enable",
    adminDeleteUser: "Remove",
    adminDeleteUserConfirm: 'Permanently remove user "{name}"?',
    adminDisableUserConfirm: 'Disable user "{name}"?',
    adminRevokeInvite: "Revoke",
    adminRevokeConfirm: "Revoke this invite link?",
    adminChangeRole: "Change role",
    adminUserCreated: "User created",
    adminInviteCreated: "Invite created — copy the link below",
  ...
  es: {
    ...
    authModePassword: "Contraseña",
    authModeToken: "Token de acceso",
    authTokenHint: "Para Home Assistant y migración. Prefiere iniciar sesión con contraseña si tienes cuenta.",
    confirmPassword: "Confirmar contraseña",
    passwordMismatch: "Las contraseñas no coinciden",
    passwordTooShort: "La contraseña debe tener al menos 8 caracteres",
    inviteSubtitle: "Acepta tu invitación",
    inviteAccept: "Crear cuenta",
    inviteAccepting: "Creando cuenta…",
    inviteMissing: "El enlace de invitación falta o está incompleto",
    inviteInvalid: "Invitación no válida",
    inviteRevoked: "Esta invitación ha sido revocada",
    inviteExpired: "Esta invitación ha caducado",
    inviteUsed: "Esta invitación ya fue utilizada",
    inviteUnavailable: "Esta invitación no está disponible",
    language: "Idioma",
    langEn: "English",
    langEs: "Español",
    ...
    adminInvitesTitle: "Invitaciones",
    adminInvitesHint: "Enlaces mágicos — copia y comparte fuera de banda",
    adminCreateUser: "Crear usuario",
    adminCreateUserBtn: "Crear usuario",
    adminCreateInvite: "Crear invitación",
    adminCreateInviteBtn: "Crear invitación",
    adminRole: "Rol",
    roleRead: "lectura",
    roleAdmin: "admin",
    ...
    adminInviteCopyOnce: "Copia este enlace ahora — no se mostrará de nuevo",
    adminCopyLink: "Copiar enlace",
    adminCopied: "Copiado",
    adminPurgeInvites: "Purgar antiguas",
    adminPurgeConfirm: "¿Eliminar todas las invitaciones convertidas, revocadas y caducadas?",
    adminPurgeDone: "Se purgaron {count} invitación(es)",
    adminNoUsers: "Aún no hay usuarios con contraseña.",
    adminNoInvites: "Aún no hay invitaciones.",
    adminCreated: "Creado",
    adminLastLogin: "Último acceso",
    adminNever: "Nunca",
    adminExpires: "Caduca",
    adminStatus: "Estado",
    adminDisabled: "Deshabilitado",
    adminDisable: "Deshabilitar",
    adminEnable: "Habilitar",
    adminDeleteUser: "Eliminar",
    adminDeleteUserConfirm: '¿Eliminar permanentemente al usuario "{name}"?',
    adminDisableUserConfirm: '¿Deshabilitar al usuario "{name}"?',
    adminRevokeInvite: "Revocar",
    adminRevokeConfirm: "¿Revocar este enlace de invitación?",
    adminChangeRole: "Cambiar rol",
    adminUserCreated: "Usuario creado",
    adminInviteCreated: "Invitación creada — copia el enlace abajo",
