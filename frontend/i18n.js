...
const messages = {
  en: {
    ...
    adminCreateUserHint: "Create a password account directly, without a magic-link invite.",
  ...
  es: {
    ...
    adminCreateUserHint: "Crea una cuenta con contraseña directamente, sin invitación por enlace mágico.",
